(function(){
  ...
  function postIdFromPath(path){var m=String(path||location.pathname).match(/(?:^|\/)blog\/([^/?#]+?)(?:\.html)?\/?$/);return m&&INTERACTION_POSTS[m[1]]?m[1]:null;}
  ...
  function setPdfHref(a){var entries=pdfEntries(INTERACTION_POSTS[a.dataset.pdfPost]),entry=entries[Number(a.dataset.pdfIndex)||0];if(entry)a.href=localized(entry.url);}

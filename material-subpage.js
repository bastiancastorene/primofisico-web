(function(){
  ...
  var TEACHING_GROUPS=[
    {id:'classical-mechanics',title:{en:'Classical Mechanics',es:'Mecánica Clásica',de:'Klassische Mechanik',zh:'经典力学'},description:{en:'Classes, tutorials and worked problems on Lagrangian mechanics.',es:'Clases, ayudantías y problemas resueltos de mecánica lagrangiana.',de:'Lehrveranstaltungen, Übungen und gelöste Aufgaben zur Lagrangeschen Mechanik.',zh:'关于拉格朗日力学的课程、习题课与解题材料。'}},
